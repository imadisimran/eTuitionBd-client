      ...
      <div className="card w-full max-w-3xl bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {/* --- Row 3: Class & Medium (Select Boxes) --- */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="form-control">
                <label className="label">
            ...
            {/* --- Row 4: Salary Range (Using Inputs for Precision) --- */}
            {/* Note: A native HTML double-thumb slider doesn't exist without 3rd party libraries. 
                Using two inputs is standard for Min/Max logic. */}
            <div className="form-control">
              <label className="label">
            ...
            {/* --- Row 5: Gender & Mode (Radio Groups) --- */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Teacher Gender */}
              <div className="form-control">
                <label className="label">
            ...
            {/* --- Row 6: Days Per Week (Radio/Segmented) --- */}
            <div className="form-control">
              <label className="label">
